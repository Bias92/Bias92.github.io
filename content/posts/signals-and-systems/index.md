...
![연속시간 신호와 이산시간 신호](fig2.svg)

회색 곡선은 모든 실수 $t$에서 값을 갖는 연속시간 신호이고, 빨간 점은 $t = kT_s$에서만 값을 갖는 이산시간 신호다. 두 신호를 구분할 때는 함수값의 높이가 아니라 점이 $t$축의 어디에 찍혀 있는지를 본다.
